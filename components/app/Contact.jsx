    ...
    <div className="p-8 text-white h-full">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-4">
          <a href="mailto:aaileenuni@gmail.com" className="group block bg-gray-800/50 backdrop-blur-sm rounded-xl p-5 border border-gray-700/50 hover:border-purple-500/50 transition-all">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-400 text-sm">aaileenuni@gmail.com</p>
              </div>
              <Icon icon="mdi:arrow-right" className="w-5 h-5 text-gray-500 group-hover:text-purple-400 transition-colors" />
            </div>
          </a>

          <a href="https://www.google.com" target="_blank" rel="noopener noreferrer" className="group block bg-gray-800/50 backdrop-blur-sm rounded-xl p-5 border border-gray-700/50 hover:border-blue-500/50 transition-all">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-400 text-sm">google.com</p>
              </div>
              <Icon icon="mdi:arrow-right" className="w-5 h-5 text-gray-500 group-hover:text-blue-400 transition-colors" />
            </div>
          </a>

          <a href="https://github.com/aaileenssyed" target="_blank" rel="noopener noreferrer" className="group block bg-gray-800/50 backdrop-blur-sm rounded-xl p-5 border border-gray-700/50 hover:border-gray-400/50 transition-all">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-400 text-sm">@aaileenssyed</p>
              </div>
