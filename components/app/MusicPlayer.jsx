  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 flex gap-6 h-full">
        ...
        <div className="w-80 bg-black/20 backdrop-blur-sm rounded-xl p-4 flex flex-col">
          <h4 className="text-sm font-semibold text-gray-400 mb-3">PLAYLIST ({playlist.length})</h4>
